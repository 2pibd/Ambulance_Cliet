 ...
 */
public class AmbulanceFREEZERFragment extends Fragment {
    ...
    public AmbulanceFREEZERFragment getInstance(List<AmbulanceModel> list_){
        this.list = list_;
        return new AmbulanceFREEZERFragment();
    }


    public AmbulanceFREEZERFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_ambulance_freezer, container, false);
        context = view.getContext();
        ButterKnife.bind(this, view);

        if (MapsActivity.ambulanceFREEZER.size() > 0) {
            tv_no_ambulance.setVisibility(View.GONE);

            ambulanceAdapters mAdapter = new ambulanceAdapters(context, MapsActivity.ambulanceFREEZER);
