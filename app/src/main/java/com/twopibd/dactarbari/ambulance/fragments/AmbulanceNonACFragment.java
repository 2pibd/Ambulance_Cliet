 ...
 */
public class AmbulanceNonACFragment extends Fragment {
    ...
    public AmbulanceNonACFragment getInstance(List<AmbulanceModel> list_){
        this.list = list_;
        return new AmbulanceNonACFragment();
    }


    public AmbulanceNonACFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_ambulance_non_ac, container, false);
        context = view.getContext();
        ButterKnife.bind(this, view);

        if (MapsActivity.ambulanceNON_AC.size() > 0) {
            tv_no_ambulance.setVisibility(View.GONE);

            ambulanceAdapters mAdapter = new ambulanceAdapters(context, MapsActivity.ambulanceNON_AC);
