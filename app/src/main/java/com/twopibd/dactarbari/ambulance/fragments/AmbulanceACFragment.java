 ...
 */
public class AmbulanceACFragment extends Fragment {
    ...
    static List<AmbulanceModel> list = new ArrayList<>();



    public static AmbulanceACFragment getInstance(List<AmbulanceModel> list_){
        list = list_;
        return new AmbulanceACFragment();
    }


    public AmbulanceACFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_ambulance_ac, container, false);
        context = view.getContext();
        ButterKnife.bind(this, view);

        if (MapsActivity.ambulanceAC.size() > 0) {
            tv_no_ambulance.setVisibility(View.GONE);

            ambulanceAdapters mAdapter = new ambulanceAdapters(context, MapsActivity.ambulanceAC);
