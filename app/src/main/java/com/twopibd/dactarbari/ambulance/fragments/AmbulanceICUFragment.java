 ...
 */
public class AmbulanceICUFragment extends Fragment {
    ...
    public AmbulanceICUFragment getInstance(List<AmbulanceModel> list_){
        this.list = list_;
        return new AmbulanceICUFragment();
    }


    public AmbulanceICUFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_ambulance_icu, container, false);
        context = view.getContext();
        ButterKnife.bind(this, view);

        if (MapsActivity.ambulanceICU.size()  > 0) {
            tv_no_ambulance.setVisibility(View.GONE);

            ambulanceAdapters mAdapter = new ambulanceAdapters(context, MapsActivity.ambulanceICU);
